...
def sanitize_html(html):
    ...
    allowed_tags = ['p', 'br', 'div', 'section', 'article',
                    'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 
...
def main():
    ...
    parser.add_argument('-f', '--format', choices=['epub', 'mobi', 'azw3'],
                        default='epub', help='Output format')
    ...
    if not calibredb_path:
        sys.exit("""Error: calibredb not found. Ensure Calibre is installed.
